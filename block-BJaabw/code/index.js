...
function minToSec(minutes) {
  ...
  return console.log(`Converted mins to secs are ${convert}`)
}
...
function appropiateDrinks(age) {
  if(age<14){
    console.log(`drink fruit juice`);
  }
  else if(age<18){
    console.log(`drink soda`);
  }
  else if(age<21){
    console.log(`drink fruit-flavored beer`);
  }
  else if(age>21){
    console.log(`drink throat-piercing vodka`);
  }
}
appropiateDrinks(16);
appropiateDrinks(45);
